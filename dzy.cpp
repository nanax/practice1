...
{       char name[20];               //姓名
	...
	for(i=0;i<num;i++){
		...
		ofile<<"政治成绩"<<'\t'<<altogether[i].mark.pol<<endl;
        ofile<<"语文成绩"<<'\t'<<altogether[i].mark.chn<<endl;
        ofile<<"英语成绩"<<'\t'<<altogether[i].mark.eng<<endl;
        ofile<<"计算机成绩"<<'\t'<<altogether[i].mark.com<<endl;
